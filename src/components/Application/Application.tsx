  ...
  return (
    <div class={styles.welcomer}>
      <div class={styles.header}>
        <div class={styles.party_vector}><PartyWelcomeVecotr /></div>
        <div class={styles.welcome}>WELCOME TO</div>
        <div class={styles.name}>SPOTIFY LISTS</div>
        <div class={styles.description}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dolor mollis leo proin turpis eu hac. Torto</div>
      </div>
      <div class={styles.dog_vector}><DogWelcomerVector /></div>
      <div class={styles.welcome_blob}><WelcomeBlob /></div>
    </div>
  )
}
